    ...
    d.fn.tableExport = function(k) {
        ...
        function R(b) {
            ...
            d(b).find("thead").first().find("th").each(function(b, c) {
                ...
                var l = J(c);
                for (e += l ? l: 1; f < e;) a[f] = b ? d(c).attr("data-field") : f.toString(),
                    f++
            });
            return a
        }
            ...
            if ("function" === typeof f) {
                ...
                if (!1 === l && (0 === a.ignoreRow.length || -1 === d.inArray(e, a.ignoreRow) && -1 === d.inArray(e - p, a.ignoreRow)) && I(d(b))) {
                    ...
                    b.each(function() {
                        ...
                        d.each(G,
                            function() {
                                if (e > this.s.r && e <= this.e.r && h >= this.s.c && h <= this.e.c) for (l = 0; l <= this.e.c - this.s.c; ++l) q++,
                                    u++,
                                    f(null, e, h++)
                            });
                        if (c || a) a = a || 1,
        ...
        function va(b, c) {
            ...
            if ("window" === a.outputMode) window.URL = window.URL || window.webkitURL,
            ...
            function c(b) {
                if (b.url) if (b.src) {
                    ...
                    e.length && (p = ++f, html2canvas(e[0]).then(function(c) {
                        b.src = c.toDataURL("image/png"); --f || a(p)
                    }))
                }
            }
            var p = 0,
                f = 0;
            if ("undefined" !== typeof b.images) for (var l in b.images) b.images.hasOwnProperty(l) && c(b.images[l]); (b = f) || (a(p), b = void 0);
            return b
        }
        function za(b, c, e) {
            c.each(function() {
                ...
                if (c.length) {
                    ...
                    for (var q = !1,
                        ...
                        var u = c.innerText || c.textContent || "",
                            g = u.length && " " === u[0] ? " ": "",
                            k = 1 < u.length && " " === u[u.length - 1] ? " ": ""; ! 0 !== a.preserve.leadingWS && (u = g + la(u)); ! 0 !== a.preserve.trailingWS && (u = ma(u) + k);
                        d(c).is("br") && (p = b.textPos.x, f += e.doc.internal.getFontSize());
                        d(c).is("b") ? q = !0 : d(c).is("i") && (h = !0); (q || h) && e.doc.setFontType(q && h ? "bolditalic": q ? "bold": "italic");
                        if (g = e.doc.getStringUnitWidth(u) * e.doc.internal.getFontSize()) {
                            ...
                            if ("visible" !== b.styles.overflow) for (; u.length && p + g > b.textPos.x + b.width;) u = u.substring(0, u.length - 1),
                                g = e.doc.getStringUnitWidth(u) * e.doc.internal.getFontSize();
                            e.doc.autoTableText(u, p, f, l);
                            p += g
                        }
                        if (q || h) d(c).is("b") ? q = !1 : d(c).is("i") && (h = !1),
                            e.doc.setFontType(q || h ? q ? "bold": "italic": "normal");
                        c = c.nextSibling
                    }
                    b.textPos.x = p;
                    b.textPos.y = f
        ...
        function Ma(b) { - 1 < b.indexOf("%") ? (b = na(b.replace(/%/g, "")), !1 !== b && (b /= 100)) : b = !1;
            return b
        }
        function D(b, c, e, p) {
            var f = "",
            ...
            if (null !== b) {
                ...
                if (q[0].hasAttribute("data-tableexport-canvas")) var h = "";
                else if (q[0].hasAttribute("data-tableexport-value")) h = (h = q.attr("data-tableexport-value")) ? h + "": "",
                    q.data("teUserDefText", 1);
                else if (h = q.html(), "function" === typeof a.onCellHtmlData) h = a.onCellHtmlData(q, c, e, h),
                    q.data("teUserDefText", 1);
                else if ("" !== h) {
                    b = d.parseHTML(h);
                    var g = 0,
                    ...
                    d.each(b,
                        function() {
                            ...
                            else if (d(this).is("select")) h += q.find("select option:selected").eq(k++).text();
                ...
                if (h && "" !== h && !0 === a.htmlContent) f = d.trim(h);
                else if (h && "" !== h) if ("" !== q.attr("data-tableexport-cellformat")) {
                    var m = h.replace(/\n/g, "\u2028").replace(/(<\s*br([^>]*)>)/gi, "\u2060"),
                    ...
                    d.each(n.text().split("\u2028"),
                        function(b, c) {
                            0 < b && (m += " "); ! 0 !== a.preserve.leadingWS && (c = la(c));
                            m += !0 !== a.preserve.trailingWS ? ma(c) : c
                        });
                    d.each(m.split("\u2060"),
                        function(b, c) {
                            0 < b && (f += "\n"); ! 0 !== a.preserve.leadingWS && (c = la(c)); ! 0 !== a.preserve.trailingWS && (c = ma(c));
                            f += c.replace(/\u00AD/g, "")
                        });
                    f = f.replace(/\u00A0/g, " ");
                    if ("json" === a.type || "excel" === a.type && "xmlss" === a.mso.fileFormat || !1 === a.numbers.output) b = na(f),
                    !1 !== b && (l = "number", f = Number(b));
                    else if (a.numbers.html.decimalMark !== a.numbers.output.decimalMark || a.numbers.html.thousandsSeparator !== a.numbers.output.thousandsSeparator) if (b = na(f), !1 !== b) {
                ...
                } else f = h; ! 0 === a.escape && (f = escape(f));
        ...
        function ea(b, a) { (b = /^rgb\((\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3})\)$/.exec(b)) && (a = [parseInt(b[1]), parseInt(b[2]), parseInt(b[3])]);
            return a
        }
        function Ca(b) {
        ...
        function ka(b, c, d) {
            ...
            if (!1 !== b && window.navigator.msSaveOrOpenBlob) window.navigator.msSaveOrOpenBlob(new Blob([d]), b);
                ...
                if (f) {
                    var l = null;
                    f.style.display = "none"; ! 1 !== b ? f.download = b: f.target = "_blank";
                    "object" === typeof d ? (window.URL = window.URL || window.webkitURL, e = [], e.push(d), l = window.URL.createObjectURL(new Blob(e, {
                        type: c
                    })), f.href = l) : 0 <= c.toLowerCase().indexOf("base64,") ? f.href = c + L(d) : f.href = c + encodeURIComponent(d);
                    document.body.appendChild(f);
                    if (document.createEvent) null === ha && (ha = document.createEvent("MouseEvents")),
                        ha.initEvent("click", !0, !1),
                        f.dispatchEvent(ha);
        ...
        if ("csv" === a.type || "tsv" === a.type || "txt" === a.type) {
            ...
            var qa = function(b, c, e) {
                b.each(function() {
                    t = "";
                    E(this, c, n, e + b.length,
                        function(b, c, d) {
                            var e = t,
                                f = "";
                            if (null !== b) if (b = D(b, c, d), c = null === b || "" === b ? "": b.toString(), "tsv" === a.type) b instanceof Date && b.toLocaleString(),
                                f = V(c, "\t", " ");
            ...
            r = y(d(B));
            d(r).each(function() {
                E(this, "th,td", n, r.length,
                    function(b, c, d) {
                        b = D(b, c, d) || ""; - 1 < b.indexOf(a.sql.columnEnclosure) && (b = V(b.toString(), a.sql.columnEnclosure, a.sql.columnEnclosure + a.sql.columnEnclosure));
            ...
            d(B).filter(function() {
                            ...
                            function(a, c, l) {
                                if (null !== a) {
                                    ...
                                    if (!1 !== jQuery.isNumeric(c)) l = "Number";
                                        ...
                                        var g = Ma(c); ! 1 !== g && (c = g, l = "Number", h += ' ss:StyleID="pct1"')
                                    }
                                    ...
                                    d.each(e,
                                        function() {
                                            if (n >= this.s.r && n <= this.e.r && f >= this.s.c && f <= this.e.c) for (var a = 0; a <= this.e.c - this.s.c; ++a) f++,
                                                b++
                                        });
                                    if (a || g) a = a || 1,
                                        g = g || 1,
                ...
                F.push(d("<div />").text(e).html()); ! 1 === a.exportHiddenCells && (K = c.find("tr, th, td").filter(":hidden"), U = 0 < K.length);
                n = 0;
                S = R(this);
                H = "<Table>\r";
                e = b(y(c), "th,td", 0);
            ...
            z = {};
            for (var m, Z, X = 0,
                     da = F.length; X < da; X++) m = F[X],
                Z = k[m],
                Z = k[m] = null == Z ? 1 : Z + 1,
            2 === Z && (F[z[m]] = F[z[m]].substring(0, 29) + "-1"),
                1 < k[m] ? F[X] = F[X].substring(0, 29) + "-" + k[m] : z[m] = X;
            ...
            for (z = 0; z < sa.length; z++) k += '<Worksheet ss:Name="' + F[z] + '" ss:RightToLeft="' + (a.mso.rtl ? "1": "0") + '">\r' + sa[z],
            ...
            d(B).filter(function() {
                ...
                for (var b = d(this), c = {},
                         e = this.getElementsByTagName("tr"), g = {
                        s: {
                            r: 0,
                            c: 0
                        },
                        e: {
                         ...
                         f = [], l, q = [], h = 0, u = 0, k, m, n, t, r, w = XLSX.SSF.get_table(); h < e.length && 1E7 > u; ++h) if (k = e[h], m = !1, "function" === typeof a.onIgnoreRow && (m = a.onIgnoreRow(d(k), h)), !0 !== m && (0 === a.ignoreRow.length || -1 === d.inArray(h, a.ignoreRow) && -1 === d.inArray(h - e.length, a.ignoreRow)) && !1 !== I(d(k))) {
                    var y = k.children,
                        B = 0;
                    for (k = 0; k < y.length; ++k) r = y[k],
                        t = +J(r) || 1,
                        B += t;
                    var z = 0;
                    for (k = m = 0; k < y.length; ++k) if (r = y[k], t = +J(r) || 1, l = k + z, !ta(d(r), B, l + (l < m ? m - l: 0))) {
                        z += t - 1;
                        ...
                        if (null != l) if (0 === l.length) v.t = "z";
                        else if (0 !== l.trim().length && "s" !== A) if ("function" === C.type) v = {
                            f: l
                        };
                        else if ("TRUE" === l) v = {
                            t: "b",
                        ...
                        else if ("" === A && d(r).find("a").length) l = "href" !== a.htmlHyperlink ? l: "",
                            v = {
                        ...
                        } else if (!1 !== (r = La(l)) || "d" === A) 0 === x && "function" !== typeof a.mso.xslx.formatId.date && (x = a.mso.xslx.formatId.date),
                            v = {
                                t: "d",
                                v: !1 !== r ? r: l,
            ...
            d(B).filter(function() {
                ...
                var b = d(this);
                "" === ba && (ba = a.mso.worksheetName || b.find("caption").text() || "Table", ba = d.trim(ba.replace(/[\\\/[\]*:?'"]/g, "").substring(0, 31))); ! 1 === a.exportHiddenCells && (K = b.find("tr, th, td").filter(":hidden"), U = 0 < K.length);
                n = 0;
                G = [];
                S = R(this);
                H += "<table><thead>";
                        ...
                        function(c, g, f) {
                            if (null !== c) {
                                ...
                                if (a.mso.styles.length) {
                                    ...
                                    for (var k in a.mso.styles) h = g[a.mso.styles[k]],
                                    "" === h && (h = f[a.mso.styles[k]]),
                                    "" !== h && "0px none rgb(0, 0, 0)" !== h && "rgba(0, 0, 0, 0)" !== h && (q += "" === q ? 'style="': ";", q += a.mso.styles[k] + ":" + h)
                                }
                                t += "<td";
                                "" !== q && (t += " " + q + '"');
                                q = J(c);
            ...
            Ha.addHTML(d(B).first(), a.jspdf.margins.left, a.jspdf.margins.top, k,
                function() {
                    va(Ha, !1)
                })
        } else {
            ...
            if (null == g.doc && (g.doc = new jsPDF(a.jspdf.orientation, a.jspdf.unit, a.jspdf.format), g.wScaleFactor = 1, g.hScaleFactor = 1, "function" === typeof a.jspdf.onDocCreated)) a.jspdf.onDocCreated(g.doc); ! 0 === g.outputImages && (g.images = {});
            "undefined" !== typeof g.images && (d(B).filter(function() {
                return I(d(this))
            }).each(function() {
                var b = 0;
                G = []; ! 1 === a.exportHiddenCells && (K = d(this).find("tr, th, td").filter(":hidden"), U = 0 < K.length);
                r = y(d(this));
                w = C(d(this));
                d(w).each(function() {
                    E(this, "td,th", r.length + b, r.length + w.length,
                        function(a) {
                            xa(a, d(a).children(), g)
                        });
                    b++
                ...
                function() {
                    d(B).filter(function() {
                        ...
                        "function" !== typeof c.drawCell && (c.drawCell = function(a, b) {
                            ...
                            if (!0 !== ("undefined" !== typeof c && c.isCanvas)) wa(a, b, c) && (g.doc.rect(a.x, a.y, a.width, a.height, a.styles.fillStyle), "undefined" === typeof c || "undefined" !== typeof c.hasUserDefText && !0 === c.hasUserDefText || "undefined" === typeof c.elements || !c.elements.length ? Aa(a, {},
                                g) : (b = a.height / c.rect.height, b > g.hScaleFactor && (g.hScaleFactor = b), g.wScaleFactor = a.width / c.rect.width, b = a.textPos.y, za(a, c.elements, g), a.textPos.y = b, Aa(a, c.elements, g)));
                            else {
                                c = c.elements[0];
                        ...
                        if (0 < n) for (var e = n - 1; 0 <= e;) d.each(g.headerrows[e],
                            function() {
                                var a = this;
                        ...
                        d(w).each(function() {
                            ...
                            E(this, "td,th", n, r.length + w.length,
                                function(c, e, f) {
                                    ...
                                    a.push(D(c, e, f));
                                    "undefined" !== typeof c && null !== c ? (h = Ca(c), h.isCanvas = c.hasAttribute("data-tableexport-canvas"), h.elements = h.isCanvas ? d(c) : d(c).children(), "undefined" !== typeof d(c).data("teUserDefText") && (h.hasUserDefText = !0)) : (h = d.extend(!0, {},
                                        g.teCells[k + ":" + (b - 1)]), h.colspan = -1);
                                    g.teCells[k + ":" + b++] = h
                                });
